Feature: Agendar citas con una empresa remodeladora
    ...
    Scenario Outline: Agendar una cita exitosamente
        ...
        And seleccione una "<date>" y "<hour>" disponible para agendar mi cita con una "<company>"
        Then se muestra un "<message>" donde se indica que mi cita se ha registrado exitosamente en el sistema

        Examples:
            | function      | company               | date       | hour  | message                                             |
            | agendar citas | RemodladoraRosas      | 2021-10-10 | 10:00 | Su cita se ha registrado exitosamente en el sistema |
            | agendar citas | ConstructoraCopertino | 2021-10-10 | 11:00 | Su cita se ha registrado exitosamente en el sistema |
